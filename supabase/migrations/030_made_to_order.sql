...
-- Checkout: same as 029, plus made-to-order handling in both loops
...
'Pickup-only: creates order, inventory updates (skipped for made-to-order), deducts restricted then universal points for CBM-collection lines.';
